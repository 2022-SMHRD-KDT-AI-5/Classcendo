...
<head>
    ...
    <!-- CSS only -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/xbootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
            ...
            <div class="inner_left">
                ...
                <div class="ana">
                    <div class="anatext">성향분석</div>
                        <div class="content">
                            <p><b>Lorem ipsum dolor sit amet,</b> consectetur adipiscing elit. Suspendisse nec posuere lorem. Pellentesque hendrerit, lorem luctus porttitor vestibulum, eros sapien mattis libero, euismod congue neque nisi at ipsum. Mauris semper ipsum sit amet metus semper malesuada. Donec vel est justo, ac porta diam.</p>
                        </div>
                </div>
                <!-- 그래프 -->
                <div>
                ...
                <div class="accordion horizontal">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="content">
                                <h3>학과 추천</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse nec posuere lorem. Pellentesque hendrerit, lorem luctus porttitor vestibulum, eros sapien mattis libero, euismod congue neque nisi at ipsum. Mauris semper ipsum sit amet metus semper malesuada. Donec vel est justo, ac porta diam.
