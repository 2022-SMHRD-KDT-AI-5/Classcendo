    ...
    <header class="navbar">
        ...
        <table class="innerbox">
            <tr>
                <td class="innernav">
                    <table>
                        <tr class="inner_name">반 선택<br></tr>
                            <select>
                ...
                <td class="innersection">
                    <table>
                        ...
                        <div class = "inner_textbox">
                            <center><textarea placeholder="내용 입력" class="textarea"></textarea></center></div>
                        <div>
                            <button type="button" onclick="location.href='view.html'" class="inner_btn" >분석</button>
                        </div>
                     </table>
                </td>          
             </tr>
