    ...
    <form action="Student_record.html" class="login-form">
        ...
        <table>
            <tr>
                ...
                <td>
                    <img src="./Image/check1.png"class="img_check1" >
                </td>
            </tr>
            <tr>
                <td class="textb">
            ...
            <tr> 
                <td class="textb">
                    <input type="password" class="form-control" id="floatingInput" placeholder="PASSWORD CHECK">
                </td>
            </tr>

            <tr> 
                <td class="textb">
                    <input type="text" class="form-control" id="floatingInput" placeholder="TEACHER NAME">
                </td>
            </tr>
